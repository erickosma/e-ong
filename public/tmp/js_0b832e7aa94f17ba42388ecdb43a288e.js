...
$.extend($.validator, {
	...
	defaults: {
		...
		highlight: function( element, errorClass ) {
			$("#status").remove();
			$("#"+element.name).css('border','3px solid #A53A3A');
			$( element ).addClass( errorClass );
		},
		unhighlight: function( element, errorClass ) {
			$("#status").remove();
			$("#"+element.name).css('border','3px solid #CCCCCC');
